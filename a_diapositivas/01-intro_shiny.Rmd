...
```{r out.width="60%"}
knitr::include_graphics("https://github.com/Estacion-R/intro-shiny_profe/tree/main/claseIntro/recursos/shiny.png")
```
...
```{r out.width="100%"}
knitr::include_graphics("https://github.com/Estacion-R/intro-shiny_profe/tree/main/claseIntro/recursos/what_is_shiny.png")
```
...
knitr::include_graphics("https://github.com/Estacion-R/intro-shiny_profe/tree/main/claseIntro/recursos/ui_example.png")
